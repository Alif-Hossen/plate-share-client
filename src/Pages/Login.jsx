    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
        <div className="bg-white shadow-xl rounded-2xl p-8 max-w-sm w-full
            ...
            <form className="space-y-4" onSubmit={handleLogin}>
                ...
                <button onClick={handleGoogleSignIn} className="btn w-full rounded-xl bg-white text-black border-[#e5e5e5] hover:bg-indigo-600 transition transform hover:scale-105 active:scale-95">
