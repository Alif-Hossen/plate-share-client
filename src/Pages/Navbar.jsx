...
const Navbar = () => {
    ...
    const getGradientLinkClass = ({ isActive }) => 
        isActive 
            ? "text-blue-600 underline text-lg font-bold px-3 py-2 rounded"
            : "text-gray-700 text-lg font-semibold px-3 py-2 rounded transition-colors duration-200 hover:bg-clip-text hover:text-transparent hover:bg-gradient-to-r hover:from-purple-600 hover:to-blue-600";
        ...
        <div className="navbar bg-base-100 shadow-sm max-w-[1480px] mx-auto">
            ...
            <div className="navbar-center hidden lg:flex">
                <ul className="menu menu-horizontal px-1 flex gap-2">
                    <li><NavLink to="/" className={getGradientLinkClass}>Home</NavLink></li>
                    <li><NavLink to="/availableFoods" className={getGradientLinkClass}>Available Foods</NavLink></li>
                    {!user && <li><NavLink to="/login" className={getGradientLinkClass}>Login</NavLink></li>}
                </ul>
            </div>
