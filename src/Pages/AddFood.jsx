    ...
    const handleAddFood = async (e) => {
        ...
        const newFood = {
            ...
            donator: {
                ...
                image: user?.photoURL || 'default-user-image-url',
            },
        ...
        try {
            ...
            if (response.ok && data.success) {
                toast.success('✅ Food added successfully! Now checking Manage Foods.');
                ...
                toast.error(` Failed: ${data.message || 'Could not add food.'}`);
            }
        } catch (error) {
